...
<<<<<<< HEAD
        ...
        self.params['W2'] = self.params['W2'] - self.learning_rate * dJ_by_dW2
        self.params['b1'] = self.params['b1'] - self.learning_rate * dJ_by_db1
        self.params['b2'] = self.params['b2'] - self.learning_rate * dJ_by_db2
